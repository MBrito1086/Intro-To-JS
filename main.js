...
// What is `math` set to?
math = high - "5";
// A:undefined (5 is a string in this case that has no assigned variable)
...
let born = 1984;
let today = 2017;
// A: timsAge = today - born
        console.log("Time is " + timsAge + "years old");
...
// A: false --- (why would this be true if there isn't anything defined within the date?)
